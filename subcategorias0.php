  ...
  ?>
            ...
            <div id="content">  
                ...
                <div class="fondo"> 
                    <div class="row">
                     <div class="col-sm-6" ALIGN="left">
                        ...
                        <h3> <i  class='fas fa-tasks' style='color:#2f79b9'></i> SUB CATEGORÍAS "TEMAS" </h3>
                     </div>
	          ...
	          <div class="panel-heading">
        	    <div class="btn-group pull-right">        	    
          	      <a href="subcategorias1.php?grupoAdic=<?=$s_grupo?>" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus" ></span> Nueva Categoría</a>
	            </div>
        	  <h4><i class='glyphicon glyphicon-search'></i> Buscar Sub Categoría</h4>
	        </div>
        	...
        	<div class="panel-body">			  	          
	            ...
	            <div class="form-group row">
        	       ...
        	       <div class='col-md-4'>
         		   <label>Filtrar por nombre de la sub categoría</label>
	         	   <input type="text" class="form-control" id="q" placeholder="Sub Categoría" onkeyup='load(1);'>
         		</div>
