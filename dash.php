                  ...
                  <div class="row">
                      <div class="col-sm-12">
                        <div class="fondo" align="center">
                            ...
                            <h5>Para consultar mas fechas toque la opción en el panel de Consultar por fehas de la parte superior <i class='fas fa-arrow-circle-up' style="font-size:18px;"></i></h5>
                        </div>             
                      </div>
                  </div>
              </div>      
