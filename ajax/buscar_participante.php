 	...
 	try {
        ...
        $sTable = "reu_participante";
 	    ...
 	    if (isset($_GET['id'])){
		   ...
		   $sql = "SELECT COUNT(*) AS cuantos FROM $sTable where identidad=$id_participante";
           $stmt = $pdo->query($sql);
	    ...
	    if($action == 'ajax'){
		    ...
		    $sWhere.=" group by numeroidparticipante, nombresparticipante order by nombresparticipante";
