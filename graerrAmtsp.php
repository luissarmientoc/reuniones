 ...
 <?php 
  ...
  ?>
                ...
                <div class="fondo"> 
                    <div class="row">
                     <div class="col-sm-6" ALIGN="left">
                        ...
                        <h3> <i  class='fas fa-sign-in-alt' style='color:#2f79b9'></i> SUBCOMISIÓN MTSP </h3>
                     </div>
  	                 ...
  	                 <form class="form-horizontal" role="form" id="datos_cotizacion">
                        <div class="form-group row"> 
			              ...
			              <div class='col-md-3'>
         		             ...
         		             <input style="text-transform:uppercase;"  type="text" class="form-control" id="q5" placeholder="No MEM" onkeyup='load(1);'>
         		          </div>
         		          -->
   ...
   <?php
    // include("footer.php");
   ?>
   <script type="text/javascript" src="js/graerrAmtsp.js"></script>
  </body>
</html>
