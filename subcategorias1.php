 ...
 <?php 
  ...
  <?php  
   ...
   $pdo = new PDO($dsn);
    ...
    $s_idSubCategoriaReunion   = $partir[0];
    $tipAccion              = $partir[1];
    
    
    if ( $s_idSubCategoriaReunion != "" )
    {  
      ///////////////////////////////////////////////////////  
      ////// REALIZA LA CONSULTA DE LA marca SELECCIONADA 
      $titulo = "MODIFICAR SUB CATEGORIA";
      $s_existe = 1;
      $boton  = "Actualizar";
   ...
   {   
     $s_idSubCategoriaReunion = $_POST['idSubCategoriaReunion'];
     $s_subCategoriaReunion   = $_POST['subCategoriaReunion'];
     
     $s_subCategoriaReunion = strtoupper($s_subCategoriaReunion);
  ...
  ?>  
                  ...
                  <div class="fondo"> 
                      <div class="row">
                       <div class="col-sm-6" ALIGN="left">
                          <h3> <i class='fas fa-stream' style='color:#2f79b9'></i> SUB CATEGORÍA</h3>
                       </div> 
                       
                       <div class="col-sm-6" align="right">  					  			 
                         <p style="font-size:12px;"><i class="fas fa-user"></i> <?=$_SESSION['nombre_perfil']?></p>
                         <a href="subcategorias0.php" class="btn btn-default pull-right btn-md"><i class="fas fa-reply"></i> Regresar</a>							
                        </div>                
                      </div>
                  </div>
                  <!--- FIN BARRA DE TITULO ----> 
        ...
        ?>
                  ...
                  <div class="row">
                    <div class=" col-md-9 col-lg-9 "> 
                        <table class="table table-condensed">
                         <tbody>
                          <tr>
                              <td class='col-md-3' align="right"> Nombre de la sub categoría: </td>
                              <td> <textarea class="form-control" id="subCategoriaReunion" name="subCategoriaReunion" required style="text-transform:uppercase;"><?=$s_subCategoriaReunion?></textarea> </td>
                          </tr> 
                         </tbody>
                        </table>			
                     </div>        	      
             ...
             <input style="visibility:hidden" name="idSubCategoriaReunion" id="idSubCategoriaReunion" value="<?=$s_idSubCategoriaReunion?>"/>
