 ...
 <?php 
  ...
  ?>
            ...
            <div id="content">  
                ...
                <div class="fondo"> 
                    <div class="row">
                     <div class="col-sm-6" ALIGN="left">
                        ...
                        <h3> <i  class='fas fa-user-friends' style='color:#2f79b9'></i> PARTICIPANTES </h3>
                     </div>
	          ...
	          <div class="panel-heading">
        	    <div class="btn-group pull-right">        	    
          	      <a href="participante1.php?grupoAdic=<?=$s_grupo?>" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus" ></span> Nuevo Participante</a>
	            </div>
        	...
        	<div class="panel-body">			  	          
	            ...
	            <div class="form-group row">
        	      <div class='col-md-4'>
	         	   ...
	         	   <input type="text" class="form-control" id="q" placeholder="Participante" onkeyup='load(1);'>
         		</div>
   ...
   <?php
    // include("footer.php");
   ?>
   <script type="text/javascript" src="js/participante.js"></script>
  </body>
</html>
